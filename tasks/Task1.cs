...
namespace Tecjnology.tasks
{
    public class Task1 : ITask
    {
        public void Execute()
        {
            ...
            try
            {
                number = GetNumberApi(result);
            }
            catch(Exception ex) 
            {
                Console.WriteLine("Problems with Api, the string will be generated by means of .NET" + ex.Message);
                Random random = new Random();
                number = random.Next(1, 10);
            }
            DeletSymbol(result,number);
        }
        ...
        private int GetNumberApi(string str)
        {
        ...
        private void DeletSymbol(string str,int number) 
        {
            ...
            if ((number > 0) && (number <= str.Length)) 
            {
                ...
                Console.WriteLine("Error: character position in string is incorrect");
        }
    }
